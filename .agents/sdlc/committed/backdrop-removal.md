...
## Acceptance Criteria
- [ ] Opening a session pane no longer darkens or blurs the rest of the application.
- [ ] Dialogs still open/close properly with focus trapping and ESC dismissal.
- [ ] No residual overlay opacity remains during normal pane usage.
- [ ] Pane borders and background readability remain unchanged.
